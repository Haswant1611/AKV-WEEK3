...
const options = {
  definition: {
    ...
    info: {
      title: 'Haswant Inventory Management ',
      version: '1.0.0',
  ...
  apis: [
    './v1/profile/api-docs/*.docs.js',
    './v1/filesUploaded/api-docs/*.docs.js',
    './v1/auth/api-docs/*.docs.js',
    './v1/inventoryManagement/api-docs/*.docs.js',
