...
const { notFoundHandler, globalErrorHandler, socketErrorHandler } = require('./middleware/error_handler/error_handle.middleware');

const { createServer } = require("http");
const { Server } = require("socket.io");
const { encryptMiddleware, decryptMiddleware } = require('./middleware/crypto/encrypt_decrypt.middleware');
